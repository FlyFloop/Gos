...
OnTick(function(myHero)
    ...
    if IOW:Mode() == "Combo" and  IOW.isWindingUp then
   ...
   if IOW:Mode() == "Harass" and  IOW.isWindingUp and 100*GetCurrentMana(myHero)/GetMaxMana(myHero) >= KalistaMenu.Harass.Mana:Value() then
