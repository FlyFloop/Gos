local skinMeta = {
  -- A
["Aatrox"]       = {"Classic", "Adalet Işığı", "Meka", "Deniz Avcısı"},
["Ahri"]         = {"Classic", "Hanedan", "Geceyarısı", "Tilki Ateşi", "Popstar", "Gözüpek", "Okullu"},
["Akali"]        = {"Classic", "Stinger", "Crimson", "Forvet", "Hemşire", "Kanlı Ay", "Gümüşdiş", "Kelle Avcısı"},
["Alistar"]      = {"Classic", "Kara", "Altın", "Zebani", "Longhorn", "Unchained", "Infernal", "Sweeper", "Yağmacı"},
...
["Blitzcrank"]   = {"Classic", "Paslı", "Kaleci", "Boom Boom", "Piltover Customs", "", "iBlitzcrank", "Riot", "Chroma Pack: Molten", "Chroma Pack: Cobalt", "Chroma Pack: Gunmetal", "Battle Boss"},
...
["Corki"]        = {"Classic", "UFO", "Ice Toboggan", "Red Baron", "Hot Rod", "Urfrider", "Dragonwing", "Fnatic"},
  -- D
["Darius"]       = {"Classic", "Lord", "Bioforge", "Woad King", "Pota Kralı", "Chroma Pack: Black Iron", "Chroma Pack: Bronze", "Chroma Pack: Copper", "Academy"},
["Diana"]        = {"Classic", "Dark Valkyrie", "Lunar Goddess", "Zebani"},
...
["Elise"]        = {"Classic", "Death Blossom", "Şanlı", "Kanlı Ay"},
["Evelynn"]      = {"Classic", "Shadow", "Masquerade", "Tango", "Safecracker"},
["Ezreal"]       = {"Classic", "Nottingham", "Striker", "Frosted", "Kaşif", "Pulsefire", "TPA", "Debonair", "Ace of Spades"},
  -- F 
...
["Irelia"]       = {"Classic", "Nightblade", "Aviator", "Infiltrator", "Frostblade", "Order of the Lotus"},
  -- J 
["Janna"]        = {"Classic", "Tempest", "Hextech", "Frost Queen", "Şanlı", "Forecast", "Fnatic"},
["JarvanIV"]     = {"Classic", "Commando", "Ejder Avcısı", "Darkforge", "Şanlı", "Warring Kingdoms", "Fnatic"},
...
["Jinx"]         = {"Classic", "Mafya", "Firecracker", "Slayer"},
  -- K 
...
["LeeSin"]       = {"Classic", "Geleneksel", "Acolyte", "Dragon Fist", "Muay Thai", "Havuz Partisi", "SKT T1", "Chroma Pack: Black", "Chroma Pack: Blue", "Chroma Pack: Yellow", "Knockout"},
...
["Lucian"]       = {"Classic", "Hired Gun", "Futbolcu", "Chroma Pack: Yellow", "Chroma Pack: Red", "Chroma Pack: Blue", "PROJECT"},
...
["Lux"]          = {"Classic", "Sorceress", "Spellthief", "Commando", "Imperial", "Steel Legion", "Star Guardian"},
  -- M 
["Malphite"]     = {"Classic", "Shamrock", "Coral Reef", "Marble", "Obsidian", "Glacial", "Meka", "Ironside"},
["Malzahar"]     = {"Classic", "Vizier", "Shadow Prince", "Djinn", "Overlord", "Snow Day"},
["Maokai"]       = {"Classic", "Charred", "Totemic", "Festive", "Haunted", "Kaleci"},
["MasterYi"]     = {"Classic", "Assassin", "Chosen", "Ionia", "Samuray Yi", "Kelle Avcısı", "Chroma Pack: Gold", "Chroma Pack: Aqua", "Chroma Pack: Crimson", "PROJECT"},
["MissFortune"]  = {"Classic", "Cowgirl", "Waterloo", "Secret Agent", "Candy Cane", "Road Warrior", "Mafya", "Arcade", "Kaptan"},
...
["Riven"]        = {"Classic", "Arınmış", "Crimson Elite", "Battle Bunny", "Şampiyonlar Şampiyonu", "Dragonblade", "Arcade"},
["Rumble"]       = {"Classic", "Rumble in the Jungle", "Bilgerat", "Süper Galaksi"},
["Ryze"]         = {"Classic", "Human", "Tribal", "Amca", "Triumphant", "Profesör", "Zombi", "Dark Crystal", "Pirate", "Whitebeard"},
  -- S 
...
["Soraka"]       = {"Classic", "Dryad", "Divine", "Celestine", "Reaper", "Order of the Banana", "Robot"},
...
["Tristana"]     = {"Classic", "Riot Girl", "Earnest Elf", "Firefighter", "Guerilla", "Buccaneer", "Roket Kız", "Chroma Pack: Navy", "Chroma Pack: Purple", "Chroma Pack: Orange", "Dragon Trainer"},
...
["Twitch"]       = {"Classic", "Kingpin", "Whistler Village", "Medieval", "Gangster", "Vandal", "Pickpocket", "SSW"},
  -- U 
["Udyr"]         = {"Classic", "Black Belt", "Primal", "Spirit Guard(Godyr)", "Bende İnsanım"},
...
["Volibear"]     = {"Classic", "Thunder Lord", "Northern Storm", "Runeguard", "Captain"},
  -- W 
["Warwick"]      = {"Classic", "Grey", "Urf the Manatee", "Big Bad", "Tundra Hunter", "Feral", "Firefang", "Hyena", "Yağmacı"},
...
["XinZhao"]      = {"Classic", "Commando", "Imperial", "Viscero", "Winged Hussar", "Warring Kingdoms", "Secret Agent"},
  -- Y 
["Yasuo"]        = {"Classic", "High Noon", "PROJECT", "Kanlı Ay"},
...
["Zed"]          = {"Classic", "Şokbıçaklı", "SKT T1", "PROJECT"},
["Ziggs"]        = {"Classic", "Mad Scientist", "Major", "Havuz Partisi", "Snow Day", "Master Arcanist"},
